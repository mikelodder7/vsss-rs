...
//     Scalar, u8, [u8; SECRET_SHARE_SIZE]>(threshold, limit, secret, &mut rng)?;
//
//     let secret2 = shares.combine_to_field_element::<Scalar, [(Scalar, Scalar); MAX_TEST_SHARES]>().unwrap();
//     assert_eq!(secret, secret2);
//
